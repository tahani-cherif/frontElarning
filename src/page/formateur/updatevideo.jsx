...
import { updatevideo,getVideoByid } from '../../redux/video';
                            ...
                            <form onSubmit={handleSubmit}>
                                    ...
                                    <div class="d-flex column-gap-2 justify-content-end ml-5">
                                                    <div class="btn-group2" style={{ display: 'flex',justifyContent: "end",marginRight: "104px" }}>
                                                        <Button variant="contained" color="success" type="submit" style={{}}>MODIFIER</Button>
                                                        <Button variant="contained" color="error" style={{ marginLeft: '10px' }} type="" onClick={() => { navigate(`/formateur/listecourformateur`) }}>Annuler modification </Button>
                                                    </div>
                                                </div>
                            </form >
                        )}
